...
import src.models.stores.contants as StoreConstants
...
class Store(object):
    ...
    def save_to_mongo(self):
        Database.update(StoreConstants.COLLECTION, self.json(), self._id)
    ...
    def find_by_url(cls, url):
        ...
        for i in range(0, len(url)+1):
            try:
                ...
                raise StoreErrors.StoreNotFoundException("The URL Prefix used to find the store not give us any results")
